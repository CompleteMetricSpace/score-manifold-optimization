...
def parse_args() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(
        description="Train the Rizon4 score model from existing dataset/config (non-interactive)."
    )
    ...
    parser.add_argument(
        "--config-path",
        type=str,
        default="configs/train_rizon4_quick.yaml",
    )
    parser.add_argument(
        "--dataset-path",
        type=str,
        default="data/rizon4_T100_n20000.pt",
    )
    parser.add_argument(
        "--output-dir",
        type=str,
        default="outputs/rizon4_train_demo",
    )
    parser.add_argument(
        "--model-path",
        type=str,
        default="examples/assets/flexiv_rizon4/scene.xml",
        help="Path to MuJoCo XML model (default: examples/assets/flexiv_rizon4/scene.xml).",
    )
